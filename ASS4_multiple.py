...
for p in range(2, 4):
    ...
    for i in range(start, start+len_i):
    ...
    plt.plot(E, v_d, '.', color = color_c[p-1])
    ...
    if p ==3:
        plt.plot(E, fit, 'b', label = 'distance: '+str(dist[p-1])+', fit '+str(round(a,3))+"0x + "+str(round(b,3)), color = color_c[p-1])
    else: 
        plt.plot(E, fit, 'b', label = 'distance: '+str(dist[p-1])+', fit '+str(round(a,3))+"x + "+str(round(b,3)), color = color_c[p-1])
    ##################################################################################
    ##################################################################################
